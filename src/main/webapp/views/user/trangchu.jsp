      ...
      <div class="el-wrapper">
        <div class="box-up">
          ...
          <div class="img-info">
            ...
            <div class="a-size">Available sizes : <span class="size">40 , 41 , 42 , 43</span></div>
          </div>
        </div>
						...
						<div class="row p-5">
							...
							<div class="col-lg-6 mb-0 d-flex align-items-center">
								<div class="text-align-left align-self-center">
									...
									<p class="text-center">“Mua giày chính hãng ở Censor lúc
										nào cũng được take care kỹ càng. Các bạn nhân viên check ib
										nhiệt tình, mình nhắn lúc 10, 11 giờ đêm vẫn được rep. Riết
										rồi Censor thành shop “ruột” của mình lúc nào không hay. Chúc
										shop luôn làm ăn phát đạt!”</p>
								</div>
							</div>
						</div>
					</div>
